  ...
  <div class="row g-5" style="display: none; position:absolute;margin-left:280px;" id="personal_info_block">
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Save the Information</button>
        </form>
      </div>
    </div>
</main>
...
function sidebar_choose(section) {
  ...
  document.getElementById("My_Quiz").classList.remove("active");
